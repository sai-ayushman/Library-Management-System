export function generateVerificationOtpEmailTemplate(otpCode){
  ...
  <footer style="margin-top: 20px; text-align: center; font-size: 14px; color: #666;">
    <p>Thank you, <br>BookNerd Team</p>
...
export function generateForgotPasswordEmailTemplate(resetPasswordUrl) {
  ...
  <div style="text-align: center; margin: 20px 0;">
    <a href="${resetPasswordUrl}" style="display: inline-block; font-size: 16px; font-weight: bold; color: #000; padding: 10px 20px; border: 1px solid #fff; border-radius: 5px; background-color: #fff; text-decoration: none;">
      Reset Password
    </a>
  </div>

  <p style="font-size: 16px; color: #ccc;">This link is valid for 15 minutes. If you did not request a password reset, please ignore this email.</p>
