...
const Register = () => {
  ...
  return <>
    <div className=" flex flex-col justify-center md:flex-row h-screen ">
      ...
      {/* LEFT SIDE  */}
      <div className="hidden w-full md:1/2 bg-black text-white md:flex flex-col items-center justify-center p-8 rounded-tr-[80px] rounded-br-[80px] ">
      ...
      <div className=" w-full md:w-1/2 flex items-center justify-center bg-white p-8">
        <div className=" w-full max-w-sm">
          <div className="flex justify-center mb-12">
            ...
            <p className=" text-gray-800 text-center mb-12">Please provide your information for sign up. </p>
