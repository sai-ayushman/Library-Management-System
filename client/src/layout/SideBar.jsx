...
const SideBar = ({ isSideBarOpen, setIsSideBarOpen, setSelectedComponent }) => {
  ...
  return<>
    <aside className={`${isSideBarOpen ? "left-0" : "-left-full"} z-10 transition-all duration-700 md:relative md:left-0 flex w4 w-64 bg-black text-white flex-col h-full`}
    ...
    >
      ...
      <button className="py-2 font-medium text-center bg-transparent rounded-md hover:cursor-pointer flex items-center justify-center space-x-5 mx-auto w-fi " onClick={handleLogout}>
