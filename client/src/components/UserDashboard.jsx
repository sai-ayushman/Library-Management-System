...
const UserDashboard = () => {
  ...
  return (
        ...
        <div className=" flex flex-col-reverse xl:flex-row ">
          ...
          <div className=" flex flex-[4] flex-col gap-7 lg:gap-7 xl:gap-7 lg:py-5 justify-between xl:min-h-[85.5vh] ">
            <div className=" flex flex-col gap-7 flex-[4]">
              <div className=" flex flex-col lg:flow-row gap-7 overflow-y-hidden ">
                ...
                <div className=" flex items-center gap-3 bg-white p-5 min-h-[120px] overflow-y-hidden rounded-lg transition  hover:shadow-inner duration-300">
                  <span className=" w-[2px] bg-black h-20 lg:h-full "> </span>
                  <span className=" bg-gray-300 h-20 lg:h-full min-w-20 flex justify-center items-center rounded-lg">
                    <img src={returnIcon} alt="book-icon" className="h-8 w-8" />
                  </span>
                  <p className=" text-lg xl:text-xl font-semibold">
              ...
              <div className=" flex flex-col lg:flex-row  gap-7">
                <div className=" flex items-center gap-3 bg-white p-5 max-h-[120px] overflow-y-hidden rounded-lg transition  hover:shadow-inner duration-300">
                  <span className=" w-[2px] bg-black h-20 lg:h-full "> </span>
                  <span className=" bg-gray-300 h-20 lg:h-full min-w-20 flex justify-center items-center rounded-lg">
                    <img src={browseIcon} alt="book-icon" className="h-8 w-8" />
                  </span>
            ...
            <div className=" bg-white p-7 text-lg sm:text-xl xl:text-3xl 2xl:text-4xl min-h-52 font-semibold relative flex-[3] flex justify-center items-center rounded-2xl">
              <h4 className=" overflow-y-hidden">"Embarking on the journey of reading foasters personal growth,nurturing a path towards excellence and the refinement of character"</h4>
          ...
          <div className=" flex-[2] flex-col gap-7 lg:flow-row flex lg:items-center xl:flex-col justify-between xl:gap-20 py-5">
            ...
            <div className=" flex items-center p-8 w-full sm:w-[400px] xl:w-fit m-5 xl:p-3 2xl:p-6 gap-5 h-fit xl:min-h-[150px] bg-white xl:flex-1 rounded-lg">
    ...
    //         <div className="flex flex-col gap-7 flex-[4]">
    //           {/* Borrowed Book Card */}
    //           <div className="flex items-center gap-5 bg-white p-5 min-h-[120px] rounded-lg transition hover:shadow-inner duration-300">
    //             <div className="w-[2px] bg-black h-20 lg:h-full"></div>
    //             <div className="bg-gray-300 h-20 lg:h-full min-w-20 flex justify-center items-center rounded-lg">
    //               <img src={bookIcon} alt="book-icon" className="h-8 w-8" />
    //             </div>
    //             <p className="text-lg xl:text-xl font-semibold">
    //               Your Borrowed Book List
    ...
    //             <div className="w-[2px] bg-black h-20 lg:h-full"></div>
    //             <div className="bg-gray-300 h-20 lg:h-full min-w-20 flex justify-center items-center rounded-lg">
    //               <img src={returnIcon} alt="return-icon" className="h-8 w-8" />
    //             </div>
    //             <p className="text-lg xl:text-xl font-semibold">
    //               Your Returned Book List
    //             </p>
    ...
    //           <div className="flex items-center gap-5 bg-white p-5 max-h-[120px] rounded-lg transition hover:shadow-inner duration-300">
    //             <div className="w-[2px] bg-black h-20 lg:h-full"></div>
    //             <div className="bg-gray-300 h-20 lg:h-full min-w-20 flex justify-center items-center rounded-lg">
    //               <img src={browseIcon} alt="browse-icon" className="h-8 w-8" />
    //             </div>
    //             <p className="text-lg xl:text-xl font-semibold">
    //               Let's Browse Books Inventory
    //             </p>
    ...
    //       {/* RIGHT SIDE */}
    //       <div className="flex-[2] flex flex-col justify-between gap-10 py-5 xl:min-h-[85.5vh]">
    //         {/* Pie Chart */}
    //         <div className="flex justify-center items-center h-full bg-white p-5 rounded-lg shadow-sm">
    //           <Pie
    //             data={data}
    //             options={{ cutout: 0 }}
    ...
    //         {/* Legend */}
    //         <div className="flex items-center p-6 gap-5 bg-white rounded-lg shadow-sm">
    //           <img src={logo} alt="logo" className="w-auto h-12 2xl:h-20" />
    //           <span className="w-[2px] bg-black h-full"></span>
    //           <div className="flex flex-col gap-5">
    //             <p className="flex items-center gap-3">
