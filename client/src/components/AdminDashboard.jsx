        ...
        <div className=" flex flex-col-reverse xl:flex-row ">
          ...
          <div className=" flex-[2] flex-col gap-7 lg:flex-row lg:items-center xl:flex-col justify-between xl:gap-20 py-5 ">
            ...
            <div className=" flex items-center p-8 w-full sm:w-[400px] xl:w-fit mr-5 xl:p-3 2xl:p-6 gap-5 h-fit xl:min-h-[150px] bg-white xl:flex-1 rounded-lg">
              ...
              />
              <span className="w-[2px] min-h-[60px] bg-black"></span>
            ...
            <div className=" flex flex-col-reverse lg:flex-row gap-7 flex-[4]">
              <div className=" flex flex-col gap-7 flex-1">
                <div className=" flex items-center gap-3 bg-white p-5 max-h-[120px] overflow-y-hidden rounded-lg transition hover:shadow-inner duration-300 w-full lg:max-w-[360px]">
                  ...
                  <div className=" flex flex-col items-center gap-2">
                    <h4 className=" font-bold text-3xl">{totalUsers}</h4>
                ...
                <div className=" flex items-center gap-3 bg-white p-5 max-h-[120px] overflow-y-hidden rounded-lg transition hover:shadow-inner duration-300 w-full lg:max-w-[360px]">
                  ...
                  <span className=" w-[2px] bg-black h-20 lg:h-full  "></span>
                  <div className=" flex flex-col items-center gap-2">
                    <h4 className=" font-bold text-3xl">{totalBooks}</h4>
                ...
                <div className=" flex items-center gap-3 bg-white p-5 max-h-[120px] overflow-y-hidden rounded-lg transition hover:shadow-inner duration-300 w-full lg:max-w-[360px]">
                  ...
                  <span className=" w-[2px] bg-black h-20 lg:h-full  "></span>
                  <div className=" flex flex-col items-center gap-2">
                    <h4 className=" font-bold text-3xl">{totalAdmin}</h4>
              ...
              <div className=" flex flex-col lg:flex-row flex-1 items-center justify-center ">
                <div className=" bg-white p-5 rounded-lg shadow-lg h-full flex flex-col justify-center items-center gap-4">
                  ...
                  <p className=" text-gray-600 text-sm 2xl:text-base text-center">Welcome to your admin dashhboard.Here you can manage all the setting and moniter the statistics.</p>
                </div>
              </div>
            </div>
            </div>
            <div className=" hidden xl:flex bg-white p-7 text-lg sm:text-xl xl:text-3xl 2xl:text-4xl min-h-5 font-semibold relative flex-[3] justify-center items-center rounded-2xl ">
